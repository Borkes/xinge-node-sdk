...
//定义api地址
//推送接口
var API_PUSH_TO_SINGLE_DEVICE = 'http://openapi.xg.qq.com/v2/push/single_device';     	   //推送单个设备
var API_CREATE_MULTI_DEVICE = 'http://openapi.xg.qq.com/v2/push/create_multipush'; 	   //创建批量消息
var API_PUSH_TO_MULTI_DEVICE = 'http://openapi.xg.qq.com/v2/push/device_list_multiple';  //推送批量消息，先创建批量消息
var API_PUSH_TO_SINGLE_ACCOUNT = 'http://openapi.xg.qq.com/v2/push/single_account'; 	   //推送单个账号
var API_PUSH_BY_ACCOUNTS = 'http://openapi.xg.qq.com/v2/push/account_list_multiple'; //推送批量账号，先创建批量消息
var API_PUSH_TO_ALL_DEVICES = 'http://openapi.xg.qq.com/v2/push/all_device';  			//推送所有设备
var API_PUSH_BY_TAGS = 'http://openapi.xg.qq.com/v2/push/tags_device'; 			//推送标签设备
//查询接口
var API_QUERY_PUSH_STATUS = 'http://openapi.xg.qq.com/v2/push/get_msg_status'; 		//查询群发消息发送状态
var API_QUERY_DEVICE_NUM = 'http://openapi.xg.qq.com/v2/application/get_app_device_num'; //查询应用覆盖的设备数（token总数）
var API_QUERY_TOKEN_INFO = 'http://openapi.xg.qq.com/v2/application/get_app_token_info'; 	  //查询应用的某个token的信息（查看是否有效）
var API_QUERY_ACCOUNT_TOKEN = 'http://openapi.xg.qq.com/v2/application/get_app_account_tokens'; //查询应用某帐号映射的token（查看帐号-token对应关系）
var API_QUERY_TAGS = 'http://openapi.xg.qq.com/v2/tags/query_app_tags';	  //查询应用设置的标签
var API_QUERY_TAGS_BY_DEVICE_TOKEN = 'http://openapi.xg.qq.com/v2/tags/query_token_tags'; //查询应用的某个设备上设置的标签
var API_QUERY_DEVICE_NUM_BY_TAG = 'http://openapi.xg.qq.com/v2/tags/query_tag_token_num'; //查询应用某个标签下关联的设备数
//任务取消
var API_CANCEL_TIMING_TASK = 'http://openapi.xg.qq.com/v2/push/cancel_timing_task'; //取消尚未触发的定时群发任务
//标签设置和删除
var API_SET_TAGS = 'http://openapi.xg.qq.com/v2/tags/batch_set'; //批量设置标签
var API_DELETE_TAGS = 'http://openapi.xg.qq.com/v2/tags/batch_del'; //批量删除标签
//账号映射删除接口
var API_DEL_APP_ACCOUNT_TOKEN = 'http://openapi.xg.qq.com/v2/application/del_app_account_tokens'; //删除应用中某个account映射的某个token
var API_DEL_APP_ACCOUNT_ALL_TOKEN = 'http://openapi.xg.qq.com/v2/application/del_app_account_all_tokens'; //删除应用中某account映射的所有token
 ...
 */
XingeApp.prototype.pushToSingleDevice = function (deviceToken, message, environment, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.pushToSingleAccount = function (account, message, environment, callback) {
 ...
 */
XingeApp.prototype.pushByAccounts = function (accounts, message, environment, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.pushToAllDevices = function (message, environment, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.pushByTags = function (tags, tagOperation, message, environment, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.queryPushStatus = function (pushIds, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.queryDeviceNum = function (callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.queryTags = function (start, limit, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.cancelTimingTask = function (pushId, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.setTags = function (tagsTokensMap, callback) {
 ...
 * @param {Function} callback(err, result) 回调函数
 */
XingeApp.prototype.deleteTags = function (tagsTokensMap, callback) {
 ...
 * @param {function} callback    回调函数
 */
XingeApp.prototype.queryTagsByDeviceToken = function (deviceToken, callback) {
 ...
 * @param {function} callback 回调函数
 */
XingeApp.prototype.queryDeviceNumByTag = function (tag, callback) {
...
function AndroidMessage() {
	...
	this.format = function () {
		...
		if (this.type === exports.MESSAGE_TYPE_NOTIFICATION) {
			...
			mess.small_icon = this.style.smallIcon;  //指定状态栏的小图片(xg.png),选填
			mess.icon_type = this.style.iconType;   //默认0，通知栏图标是应用内图标还是上传图标,0是应用内图标，1是上传图标,选填
			mess.icon_res = this.style.iconRes;     //应用内图标文件名（xg.png）或者下载图标的url地址，选填
			mess.builder_id = this.style.builderId; //本地通知样式，必填
			mess.style_id = this.style.styleId; //Web端设置是否覆盖编号的通知样式，默认1，0否，1是,选填
			mess.clearable = this.style.clearable; //通知栏是否可清除，选填，默认1
			mess.n_id = this.style.nId; //通知id，若大于0，则会覆盖先前弹出的相同id通知；若为0，展示本条通知且不影响其他通知；若为-1，将清除先前弹出的所有通知，仅展示本条通知。默认为0
